      ...
      <div id="content">
        <section className="hero" id="home">
          ...
          <div className="hero-copy">
            ...
            <p className="location-line"><b>●</b> Serving Dallas–Fort Worth and surrounding North Texas markets.</p>
          </div>
        ...
        <section className="coverage" id="coverage">
          <div className="coverage-copy"><p className="section-label light">LOCAL EXPERTISE</p><h2>DFW Coverage.<br/><span>Professional Local Support.</span></h2><p>Based in North Texas, Sterling Ridge Ventures LLC provides responsive onsite technology support across Dallas–Fort Worth and surrounding communities. Broader Texas coverage may be available depending on project scope and scheduling.</p><div className="market-grid">{markets.map(x => <span key={x}>• {x}</span>)}</div><a className="button primary" href="#contact">Check Project Availability <span>↗</span></a></div>
        ...
        <section className="contact section" id="contact">
          <div className="contact-lead"><p className="section-label light">START A CONVERSATION</p><h2>Let&apos;s Support Your Next <span>Technology Project.</span></h2><p>Contact Sterling Ridge Ventures LLC for dependable onsite IT coverage throughout Dallas–Fort Worth.</p><div className="contact-info"><span><small>LOCATION</small>Dallas–Fort Worth, Texas</span><a href="mailto:contact@sterlingridgeventures.com"><small>SERVICE REQUESTS</small>contact@sterlingridgeventures.com</a><a href="mailto:info@sterlingridgeventures.com"><small>GENERAL INFORMATION</small>info@sterlingridgeventures.com</a><a href="mailto:partners@sterlingridgeventures.com"><small>PARTNER INQUIRIES</small>partners@sterlingridgeventures.com</a><a href="tel:+16129877874"><small>BUSINESS PHONE</small>612-987-7874</a></div></div>
          <form className="request-form" action="https://formsubmit.co/contact@sterlingridgeventures.com" method="POST" aria-label="Request service form">
            <input type="hidden" name="_subject" value="New Sterling Ridge Ventures service request" />
            <input type="hidden" name="_next" value="https://sterlingridgeventures.com/#contact" />
            ...
            <button className="button form-button" type="submit">Submit Service Request <span>↗</span></button>
            <small className="privacy-note">By submitting this form, you agree that Sterling Ridge Ventures LLC may contact you regarding your service request. Your information will not be sold. Form submissions are securely processed by FormSubmit.</small>
          </form>
        </section>
      </div>

      <footer>
        <div className="footer-brand"><a className="brand inverse" href="#home"><span className="brand-mark"><i/><i/><i/></span><span><b>STERLING RIDGE</b><small>VENTURES LLC</small></span></a><p>Dependable onsite technology support across Dallas–Fort Worth.</p></div>
        ...
        <div><h3>Contact</h3><span>Dallas–Fort Worth, Texas</span><a href="mailto:contact@sterlingridgeventures.com">contact@sterlingridgeventures.com</a><a href="mailto:info@sterlingridgeventures.com">info@sterlingridgeventures.com</a><a href="mailto:partners@sterlingridgeventures.com">partners@sterlingridgeventures.com</a><a href="tel:+16129877874">612-987-7874</a></div>
